...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Hexa Park</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Hexapark merupakan inovasi baru dari Universitas Pendidikan Indonesia Kampus di
                Purwakarta yaitu taman yang didominasi dengan bentuk segi lima. Taman ini sering digunakan oleh
                mahasiswa untuk berdiskusi dan bertukar pikiran, makan bersama, dan istirahat sejenak setelah
                perkuliahan usai.</p>
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/hexa park.jpg",
            "autoLoad": true,
            "showControls": false
        });
