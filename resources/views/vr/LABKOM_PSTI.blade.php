...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">LABKOM PSTI</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Lab Komputer merupakan pusat praktikum dan penelitian mahasiswa Universitas
                Pendidikan Indonesia kampus di Purwakarta. Fasilitas yang tersedia di ruangan ini yaitu ruang praktikum
                komputer, ruang praktikum multimedia, ruang praktikum jaringan komputer, dan ruang praktikum
                pemrograman. Keberadaan LABKOM memberikan dukungan bagi mahasiswa untuk belajar dan mengembangkan diri
                di bidang pendidikan dan teknologi informasi.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/labkom PSTI'.jpg",
            "autoLoad": true,
            "showControls": false
        });
