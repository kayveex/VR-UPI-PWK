...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Smart Classroom</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Ruangan smartclass adalah ruang kelas yang didesain dengan nuansa modern yang
                dilengkapi kursi pembelajaran yang unik, podium (mimbar), ruangan yang lebih luas serta interior yang
                berbeda dibanding kelas lainnya dan terdapat pula mini panggung untuk dosen serta mahasiswa presentasi.
                Ruangan ini juga difasilitasi dengan teknologi yang cerdas seperti smartboard. Ruangan smartclass
                digunakan untuk kegiatan pembelajaran oleh seluruh prodi. Selain digunakan untuk kegiatan pembelajaran,
                ruangan ini digunakan juga untuk seminar dan workshop.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
