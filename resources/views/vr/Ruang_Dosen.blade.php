...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Ruang Dosen</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Ruang dosen adalah ruangan yang digunakan dosen untuk bekerja atau menyimpan
                dokumen-dokumen yang diperlukan untuk kegiatan akademik. Jumlah ruangan ini sesuai dengan jumlah dosen
                yang ada disetiap prodinya. Ruang dosen ini juga digunakan sebagai tempat mahasiswa bimbingan dengan
                dosen. Dengan fasilitas setiap meja dosen terdapat PC serta kursi.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
