...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Lapangan Teater Terbuka</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Lapangan Teater Terbuka merupakan halaman yang melingkupi gedung Noormal School.
                Lapangan ini sering digunakan sebagai panggung elegan bagi para mahasiswa untuk merayakan beragam
                kegiatan kampus. Dari perhelatan megah Dies Natalies hingga hikmatnya upacara peringatan hari besar,
                tempat ini menjadi tempat berdiskusi intelektual mahasiswa serta menyelenggarakan berbagai kegiatan yang
                memperkaya pengalaman akademis.
            </p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/lapangan teater terbuka.jpg",
            "autoLoad": true,
            "showControls": false
        });
