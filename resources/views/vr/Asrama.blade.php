...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Asrama</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Fasilitas hunian yang disediakan untuk mahasiswa UPI Purwakarta, namun asrama yang
                disediakan hanya untuk mahasiswi saja. Asrama ini didukung dengan fasilitas nyaman dan lokasi strategis
                yang dapat diakses dengan hanya berjalan kaki ke gedung perkuliahan karena lokasi asrama ini masih di
                dalam lingkungan kampus.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
