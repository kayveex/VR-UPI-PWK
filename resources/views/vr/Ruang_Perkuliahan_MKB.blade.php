...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Ruang Perkuliahan MKB</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Ruang perkuliahan MKB merupakan salah satu fasilitas penting di Universitas
                Pendidikan Indonesia kampus di Purwakarta. Dalam ruangan ini memiliki fasilitas untuk menunjang kegiatan
                belajar yang nyaman dan produktif seperti proyektor, kursi perkuliahan, whiteboard, Ac, stop kontak,
                meja dan kursi dosen. Setiap ruang perkuliahan ini memiliki jadwalnya masing-masing setiap harinya.
                Ruang perkuliahan MKB juga memberikan keleluasaan bagi dosen dan mahasiswa untuk melaksanakan kegiatan
                belajar mengajar karena jumlah mahasiswa dalam kelas selalu disesuaikan dengan kapasitas ruangan yang
                tersedia.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/ruang perkuliahan MKB.jpg",
            "autoLoad": true,
            "showControls": false
        });
