...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Gedung Pancasila</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Gedung ini terdiri dari 4 lantai, di dalamnya ada beberapa ruang perkuliahan
                mahasiswa UPI Purwakarta dan
                ruangan lainnya seperti ruang prodi, akademik, administrasi, smart classroom dan beberapa laboratorium.
            </p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
