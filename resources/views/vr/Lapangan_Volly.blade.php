...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Lapangan Volly</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Terdapat 2 lapangan volley di UPI Purwakarta, yang mana memiliki ukuran standar dan
                memiliki fasilitas berupa net. Lapangan volley ini digunakan sebagai fasilitas penunjang akademik di UPI
                Purwakarta. Berbeda dengan lapangan bola, lapangan ini lebih sering digunakan oleh mahasiswa.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/lapangan volly.jpg",
            "autoLoad": true,
            "showControls": false
        });
