...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Gedung Reformasi</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Gedung reformasi merupakan gedung 3 lantai yang di dalamnya terdapat ruang dosen, 2
                lab komputer, lobby, ruang perkuliahan PSTI serta fingerprint untuk absensi kehadiran dosen. Namun,
                tidak hanya digunakan untuk mahasiswa PSTI, gedung ini digunakan juga oleh mahasiswa prodi PGSD dan
                PGPAUD. Gedung reformasi termasuk salah satu gedung perkuliahan terlama yang didirikan di UPI
                Purwakarta.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/gedung reformasi.jpg",
            "autoLoad": true,
            "showControls": false
        });
