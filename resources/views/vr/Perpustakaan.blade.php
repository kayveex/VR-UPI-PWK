...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Perpustakaan</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Perpustakaan dianggap sebagai jantungnya universitas. Perpustakaan merupakan tempat
                dimana banyak menyimpan berbagai macam buku ilmu pengetahuan yang banyak bermanfaat, serta tempat
                mahasiswa banyak melakukan aktivitas membaca, dengan ruang yang hening jauh dari kebisingan yang mampu
                menciptakan ruang membaca yang begitu nyaman bagi mereka yang gemar membaca. Perpustakaan pada
                hakikatnya bertujuan memupuk dan menumbuhkembangkan minat serta bakat mahasiswa dan dosen untuk membaca
                dan menulis, memperkenalkan teknologi informasi, dan membiasakan mengakses informasi secara mandiri.
            </p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/Perpustakaan.jpg",
            "autoLoad": true,
            "showControls": false
        });
