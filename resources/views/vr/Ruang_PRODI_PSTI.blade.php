...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Ruang PRODI PSTI</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Ruangan ini adalah kantor bagi dosen dan bagian administrasi dari program studi
                pendidikan sistem dan teknologi informasi UPI. Di UPI Purwakarta sendiri terdapat 5 ruang prodi
                diantaranya prodi PGSD, PGPAUD, PSTI, SISTEL dan MKB. Dengan fasilitas berupa tempat penyimpanan
                dokumen, kursi serta meja dosen, wifi area, kursi tunggu tamu, printer, dispenser, PC Unit tiap tenaga
                kependidikan serta smartlock.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
