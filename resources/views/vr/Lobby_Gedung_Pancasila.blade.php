...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Lobby Gedung Pancasila</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Lobby pada gedung ini dilengkapi dengan meja resepsionis dan kursi tunggu. Setelah
                itu, terdapat pula beberapa kursi untuk mahasiswa gunakan untuk berkumpul, berdiskusi maupun kerja
                kelompok.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/lobby gedung pancasila.jpg",
            "autoLoad": true,
            "showControls": false
        });
