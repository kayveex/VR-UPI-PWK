...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">PKM UPI PWK</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">PKM UPI Purwakarta merupakan tempat pusat kegiatan mahasiswa dalam bidang kreativitas
                dan inovasi. Bangunan PKM memiliki beberapa ruangan untuk tempat kegiatan mahasiswa dari berbagai UKM.
                Ruangan ini dapat digunakan untuk kegiatan-kegiatan seperti rapat, diskusi, dan mengembangkan kemampuan
                diri. Ruangan yang berada di dalam gedung ini dilengkapi dengan fasilitas yang memadai, sehingga dapat
                menunjang kegiatan mahasiswa dengan baik.
            </p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
