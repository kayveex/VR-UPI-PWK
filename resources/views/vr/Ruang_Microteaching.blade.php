...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Ruang Microteaching</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Ruang microteaching merupakan salah satu ruangan yang berada di gedung pancasila.
                Ruangan ini dikelilingi dengan cermin yang memiliki fungsi untuk mahasiswa melakukan simulasi mengajar
                dan sidang skripsi. Fasilitas yang ada di ruang microteaching diantaranya smartTV, ruang podcast, kursi
                dan meja,. Ruangan ini memang tidak sebesar ruangan lainnya, karena tidak digunakan untuk kegiatan
                belajar.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
