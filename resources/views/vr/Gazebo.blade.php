...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Gazebo</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Gazebo merupakan tempat yang dibangun di tengah gedung-gedung perkuliahan Universitas
                Pendidikan Indonesia kampus di Purwakarta. Gazebo ini dibuat dari kayu yang memiliki atap berbentuk
                segitiga. Tempat ini biasa digunakan oleh mahasiswa untuk bersantai, berdiskusi hingga mengerjakan tugas
                bersama. Keunggulan dari tempat ini adalah lokasi yang strategis, suasana yang sejuk dan segar sehingga
                nyaman dan menyenangkan untuk bersantai.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/gazebo.jpg",
            "autoLoad": true,
            "showControls": false
        });
