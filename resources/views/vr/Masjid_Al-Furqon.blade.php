...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Masjid Al-Furqon</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Masjid Al - Furqan merupakan tempat beribadah yang digunakan oleh mahasiswa maupun
                masyarakat umum. Masjid ini sering mengadakan berbagai acara keagamaan mulai dari Tabligh akbar, Maulid
                Nabi, dan acara besar islam lainnya. Bangunan ini terletak di sebelah kanan gerbang masuk Universitas
                Pendidikan Indonesia Kampus di Purwakarta. Jika dilihat sekilas, bangunan masjid menampilkan kesan
                minimalis. Kesan ini didapat dari bentuk dasar bangunan yang berupa kotak dengan kecenderungan vertikal.
                Kombinasi warna putih dengan abu - abu yang semakin menegaskan kesan minimalis tersebut.
            </p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/Masjid Kepotong.jpg",
            "autoLoad": true,
            "showControls": false
        });
