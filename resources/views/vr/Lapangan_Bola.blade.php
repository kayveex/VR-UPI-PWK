...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Lapangan Bola</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Lapangan bola memiliki ukuran standar dan memiliki fasilitas berupa gawang. Lapangan
                bola ini sering digunakan untuk berbagai kegiatan olahraga serta kompetisi internal maupun interlokal
                baik oleh mahasiswa maupun masyarakat umum (warga setempat). Dengan kondisi lapangan yang baik, membuat
                suasana yang nyaman dan aman sesuai standar.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/lapangan bola.jpg",
            "autoLoad": true,
            "showControls": false
        });
