...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">BEM UPI PWK</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Gedung BEM UPI Purwakarta merupakan salah satu bangunan yang terletak di kampus UPI
                Purwakarta. Gedung ini berfungsi sebagai pusat kegiatan mahasiswa, terutama kegiatan yang berkaitan
                dengan Badan Eksekutif Mahasiswa (BEM). Gedung BEM UPI Purwakarta sering untuk berbagai kegiatan
                mahasiswa, seperti rapat, seminar, diskusi, dan berbagai kegiatan lainnya yang dapat mengembangkan diri.
                Selain itu, BEM UPI Purwakarta merupakan salah satu fasilitas yang penting bagi mahasiswa. Karena
                keberadaan gedung ini memberikan ruang bagi mahasiswa untuk mengembangkan potensi dan kreativitasnya
                melalui berbagai kegiatan mahasiswa.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/BEM UPI PWK.jpg",
            "autoLoad": true,
            "showControls": false
        });
