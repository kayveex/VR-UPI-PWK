...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Ruang Administrasi UPI PWK</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Ruang administrasi merupakan ruang bagi pegawai untuk memberikan pelayanan
                administrasi bagi mahasiswa dan dosen. Ruang ini dikelola oleh tenaga administrasi dilengkapi dengan
                printer, PC, tempat penyimpanan dokumen. Melalui ruang ini informasi akademik dan surat menyurat.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
