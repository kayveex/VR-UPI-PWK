...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Aula Timur</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <p class="canvas-para">Aula Timur telah menjadi saksi berbagai peristiwa penting di Universitas Pendidikan
                Indonesia kampus di Purwakarta termasuk seminar, konferensi, dan berbagai acara lainnya. Ruangan ini
                juga digunakan untuk kegiatan organisasi mahasiswa, seperti rapat dan diskusi lainnya. Aula timur sudah
                difasilitasi dengan AC sehingga kegiatan dapat berjalan dengan nyaman dan produktif.</p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
    <div id="panorama">
    ...
    <script>
        viewer = pannellum.viewer('panorama', {
            "panorama": "/assets/img/footage/aula timur.jpg",
            "autoLoad": true,
            "showControls": false
        });
